...
BEGIN
    SELECT cr.id, da.availabledate, cr.starttime, cr.endtime, cr.doctoravailabilityid, ds.doctorid, array_agg(ds.servicename) 
    INTO res.id, res.availabledate, res.start_time, res.end_time, res.doctor_availability_id, res.doctor_id, res.service_names
