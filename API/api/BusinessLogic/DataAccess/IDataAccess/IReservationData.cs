...
namespace api.BusinessLogic.DataAccess.IDataAccess
{
    public interface IReservationData
    {
        ...
        Task<Result> DeleteSpecificReservationAsync(int ClientReservationId, string userdata, string accessToken);
        ...
        Task<Result> MarkCompleteReservationAsync(int ClientReservationId);
